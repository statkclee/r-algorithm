...
| 선형검색 | 이진검색 |
| --------------------|--------------------|
| 100개 항목 &rarr; 100번 검색 | 100개 항목 &rarr; `r round(log2(100),0)`번 검색(log2(100)=`r round(log2(100),1)`) | 
| 7,000,000,000개 항목 &rarr; 7,000,000,000번 검색 | 7,000,000,000개 항목 &rarr; `r round(log2(7000000000),0)`번 검색(log2(7,000,000,000) = `r round(log2(7000000000),1)`) | 
